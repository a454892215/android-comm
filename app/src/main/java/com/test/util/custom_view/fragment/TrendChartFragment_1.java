...
import com.test.util.custom_view.fragment.other.ChartDataHandler;
...
public class TrendChartFragment_1 extends BaseFragment {
    ...
    protected void initView() {
        ...
        Class[] dataHandlerArr = {ChartDataHandler.class, ChartDataHandler.class, ChartDataHandler.class, ChartDataHandler.class,};
        ...
        tab_layout_2.setOnSelectChangedListener(position -> {
            IDataHandler dataHandler = InstanceUtil.getInstance(CastUtil.cast(dataHandlerArr[position]));
            if (dataHandler != null) {
